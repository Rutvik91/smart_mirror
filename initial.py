    ...
    def get_weather(self):
        try:
            ...
            if latitude is None and longitude is None:
                ...
                # get weather
                weather_req_url = "http://api.openweathermap.org/data/2.5/forecast?id=524901&appid=".format(
                ...
                location2 = ""
                # get weather
                weather_req_url = "https://api.openweathermap.org/data/2.5/weather?q={}&units=metric&appid={}".format(
